...
SQLALCHEMY_DATABASE_URL = "mysql://root:diJgInaGMcraNvUuPsDiOFRlgLcPZOlx@switchyard.proxy.rlwy.net:21436/railway" #aqui va la ruta de la bb que está en railway configurada
